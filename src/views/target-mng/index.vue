<template>
  <div class="flex flex-column height-100-percent">
    <div class="font-size-20px font-weight mb-12px">指标库</div>
    ...
    <div class="flex-1 overflow-scroll">
      <div class="grid grid-gap-10px grid-template-columns-250px">
        <div class="target-card" v-for="target in filterTargetList" :key="target.cardId">
          <div style="min-height: 150px; height: 150px; background: #f1f2f6">
            <el-image :src="require('@/assets/preview/' + target.picUrl + '.png')"></el-image>
          </div>
